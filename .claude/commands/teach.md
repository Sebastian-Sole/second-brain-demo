---
description: Teach you anything — this conversation, this project, or any topic — pitched at how you learn.
---

@brain/tools/teach.md

The human's input, if any: $ARGUMENTS

<!-- Thin adapter. The real prompt is brain/tools/teach.md, shared by every agent — `@` inlines it
     ...
     round trip and nothing else. Don't add instructions here — edit brain/tools/teach.md instead. -->
