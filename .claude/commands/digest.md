---
description: Roll up recent activity — what happened, patterns across it, and what's stalled.
---

Produce a digest of recent activity in the second brain.

**Window:** $ARGUMENTS — interpret it loosely (`week`, `month`, `since Tuesday`, a date range).
Default to the **last 7 days** if nothing is given. State the window you used at the top.
