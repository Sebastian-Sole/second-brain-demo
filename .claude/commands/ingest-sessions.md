...
@brain/prompts/ingest-sessions.md

The human's input, if any: $ARGUMENTS

<!-- Thin adapter. The real prompt is brain/prompts/ingest-sessions.md, shared by every agent — `@` inlines it
     ...
     round trip and nothing else. Don't add instructions here — edit brain/prompts/ingest-sessions.md instead. -->
