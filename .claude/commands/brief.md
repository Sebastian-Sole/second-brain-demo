...
<!-- Thin adapter. The real prompt is brain/prompts/brief.md, shared by every agent — `@` inlines it
     ...
     round trip and nothing else. Don't add instructions here — edit brain/prompts/brief.md instead. -->
