...
4. **Separate what the vault says from what you're adding.** If you're inferring or synthesising
   across notes rather than reporting, mark it — `> [!ai]` or a plain inline note. The human must
   always be able to tell their own past thinking from your commentary.
